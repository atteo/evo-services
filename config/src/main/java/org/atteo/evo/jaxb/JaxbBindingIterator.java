 ...
 */
// TODO: add iterating over attributes
public class JaxbBindingIterator {
	...
	public JaxbBindingIterator(Binder binder, Runnable runnable) {
		this.binder = binder;
	...
	public static void iterate(Element root, Binder binder, Runnable runnable) {
		...
		JaxbBindingIterator bindRecurse = new JaxbBindingIterator(binder, runnable);
		try {
